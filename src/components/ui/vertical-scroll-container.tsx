    ...
    <div className="relative mx-3 me-5 px-4">
      ...
      {showPreviousButton && (
        <>
          ...
          <div className="absolute top-1/2 left-[30px] h-full w-[10px] -translate-y-1/2 transform bg-white blur-sm"></div>
        </>
      )}
      {showNextButton && (
        <>
          <div className="absolute top-1/2 -right-[18px] h-full w-[50px] -translate-y-1/2 transform bg-white blur-sm"></div>
          <div
            onClick={scrollRight}
            className="absolute top-1/2 -right-[15px] -translate-y-1/2 transform cursor-pointer rounded-full border border-gray-300 bg-white p-1 transition-all duration-200 hover:scale-[1.1] hover:shadow-xl"
          >
